                        ...
                        <form id="admin-form" name="addForm" action="${pageContext.request.contextPath}/ProductServlet?method=update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="panel-body bg-light">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="sn" class="field">
                                            <input name="pname" class="gui-input" placeholder="名称" type="text"
                                                   value="${product.pname}"/>
                                        </label>
                                    </div>
                                </div>
                                <div class="section row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="sn" class="field">
                                            <input name="price" class="gui-input" placeholder="1000" type="text"
                                                   value="${product.price}"/>
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="sn" class="field">
                                            <input id="sn" name="author" class="gui-input" placeholder="名称" type="text"
                                        ...
                                        <label for="sn" class="field select">
                                            <select id="departmentSn" name="cid" class="gui-input"
                                                ...
                                                <c:forEach var="c" items="${categoryList}">
                                                    <option value="${c.cid}"
                                                            <c:if test="${c.cid == product.category.cid}">selected</c:if>>${c.cname}</option>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name" class="field">
                                            <input id="name" name="filename" class="gui-input" placeholder="图片"
                                                   type="file"
                                                   value="上传图片"/>
                                        </label>
                                    </div>
